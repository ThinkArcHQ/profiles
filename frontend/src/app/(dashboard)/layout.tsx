...
export default function DashboardLayout({
  ...
  const sidebarMargin = user && hasProfile ? '64px' : '0';

  return (
    <div className="h-screen bg-[#f5f5f0] flex flex-col overflow-hidden">
      {/* Top Navigation */}
      <div className="border-b border-gray-200 bg-white/80 backdrop-blur-md flex-shrink-0 h-16 z-50 relative">
      ...
      {/* Main Content */}
      <div className="flex-1 overflow-hidden" style={{ marginLeft: sidebarMargin }}>
        {children}
      </div>
    </div>
  )
