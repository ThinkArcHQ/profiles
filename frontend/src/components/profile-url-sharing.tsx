      ...
      <CardContent className="space-y-6">
        ...
        <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-medium text-blue-800">Profile Analytics</h4>
          </div>
          ...
          {loadingAnalytics ? (
            ...
            <>
              <div className="grid grid-cols-3 gap-4 text-center mb-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-blue-700">{analytics.totalShares}</p>
                  <p className="text-xs text-blue-600 flex items-center justify-center gap-1">
                ...
                <div>
                  <p className="text-2xl font-bold text-blue-700">{analytics.totalQrScans}</p>
                  <p className="text-xs text-blue-600 flex items-center justify-center gap-1">
              ...
              <div className="grid grid-cols-2 gap-4 text-center mb-4">
                <div className="bg-white/50 rounded p-2">
                  <p className="text-lg font-semibold text-blue-700">{analytics.viewsLast7Days}</p>
                  <p className="text-xs text-blue-600">Last 7 days</p>
                </div>
                <div className="bg-white/50 rounded p-2">
                  <p className="text-lg font-semibold text-blue-700">{analytics.viewsLast30Days}</p>
              ...
              {analytics.topSources.length > 0 && (
                <div>
                  <p className="text-sm font-medium text-blue-800 mb-2">Top Sources</p>
                  <div className="space-y-1">
                    {analytics.topSources.slice(0, 3).map((source, index) => (
                      <div key={source.source} className="flex justify-between items-center text-sm">
                        <span className="text-blue-700 capitalize">{source.source}</span>
                        <span className="text-blue-600">{source.count}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-blue-600">No analytics data yet</p>
              <p className="text-xs text-blue-500">Share your profile to start tracking!</p>
            </div>
          )}
        </div>
      </CardContent>
